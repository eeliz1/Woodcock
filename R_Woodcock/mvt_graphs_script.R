...
for (file in move_files){
  ...
  png(paste("C:/Users/Elisa/Pictures/Graphs/", "mvt_", md$BandNmbr[1], ".png", sep=""))
  plot(md$dt, md$spdfdist, xlab = "Time", ylab="Distance Moved (m)",
       main=paste("Movement by", md$BandNmbr[1]), xaxt="n", type="l")
  axis.POSIXct(1, md$dt, format="%m/%d")
  dev.off()
